<template>
  <div class="order">
    <headtop title="下单" showgoback="true">
      <div slot="r">
    ...
    >
      <div class="popup-select">
        <Checklist v-model="filterGoodsType" :options="['食品', '日化', '快消']" title="请选择商品类型"></Checklist>
        <Button type="default" @click="showSelectGoodsType=false" class="btn-select-type">确定</Button>
      </div>
    </Popup>
  </div>
</template>
